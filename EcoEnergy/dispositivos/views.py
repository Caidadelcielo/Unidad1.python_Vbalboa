...
class AlertListView(ListView):
    ...
    paginate_by = 50
    ordering = ['-created_at']  # si tu modelo tiene campo created_at
...
class DashboardView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        # Alertas recientes de la última semana
        last_week = timezone.now() - timedelta(days=7)
        recent_alerts = AlertProduct.objects.select_related('id_alert', 'id_prod')\
